...
| `mcp-serve` | MCP server — exposes the tools registered by the runtime to external MCP clients over stdio. The default registry is conditional (63 always, plus optional CDP/computer/LSP tools); LSP is separately registered. | mcp, tools |
