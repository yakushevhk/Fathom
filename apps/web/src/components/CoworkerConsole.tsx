    ...
    <div className="flex-1 overflow-y-auto bg-[#080909]">
      <header className="border-b border-white/[0.08] px-5 py-5 md:px-8">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div><p className="ops-kicker">Work / autonomous worker fleet</p><h1 className="mt-1 text-xl tracking-tight text-gray-100">Workers &amp; recurring operations</h1><p className="mt-1 max-w-2xl text-xs text-gray-500">Configure autonomous workers, route their conversations, and keep recurring operations on time.</p></div>
