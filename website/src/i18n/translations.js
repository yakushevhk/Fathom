...
export const translations = {
  ...
  "arch": {
    ...
    "hero_subtitle": {
      "en": "Typed event protocol, hierarchical orchestration, durable sessions, and production-grade persistence",
      "ru": "Типизированный протокол событий, иерархическая оркестрация, долговечные сессии и надёжное хранение"
    },
    "docs": {
    ...
    "tools_desc": {
      "en": "37 Rust built-ins + extensions",
      "ru": "37 встроенных инструментов Rust + расширения"
    },
    "mcp_label": {
      "en": "MCP",
      "ru": "MCP"
  ...
  "arch_mod": {
    ...
    "title": {
      "en": "13 pillars of the architecture",
      "ru": "13 столпов архитектуры"
    },
    "m1t": {
  ...
  "landing": {
    ...
    "hero_mono": {
      "en": "Rust · 37 tools + MCP · typed RPC · one runtime",
      "ru": "Rust · 37 инструментов + MCP · typed RPC · один рантайм"
    },
    ...
    "capc": {
      "1": {
        "t": { "en": "37 Rust tools + extensions", "ru": "37 инструментов Rust + расширения" },
        "d": {
    ...
    "cta_mono": {
      "en": "fathom-research bench · docs · request access",
      "ru": "fathom-research bench · docs · запрос доступа"
    },
    "cta_access": {
      "en": "Request access →",
      "ru": "Запросить доступ →"
