...
export default {
  tools: {
    hero: {
      ...
      title1: {
        en: '50+ built-in tools',
        ru: '50+ встроенных инструментов',
      },
      titleSub: {
    ...
    mcp: {
      ...
      sub: {
        en: 'All 50+ tools are exposed to external MCP clients via mcp-serve, and external MCP servers (stdio / HTTP / OAuth) are auto-discovered and made available to agents.',
        ru: 'Все 50+ инструментов доступны внешним MCP-клиентам через mcp-serve, а внешние MCP-серверы (stdio / HTTP / OAuth) автоматически обнаруживаются и становятся доступны агентам.',
      },
