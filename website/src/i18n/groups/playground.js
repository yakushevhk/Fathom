...
export default {
  ...
  playground: {
    ...
    conn: {
      ...
      hint: {
        en: 'Start the backend with: fathom-research serve --port 8080 (an API key enables cross-origin access).',
        ru: 'Запустите бекенд: fathom-research serve --port 8080 (API-ключ включает кросс-доменный доступ).',
      },
