...
- **Windows exception: agent-browser 0.36.0-omb.1** is an Parallel vendor
...
updated through reviewed Parallel releases, not a silent browser updater.

On macOS, release signing applies Parallel's Developer ID to native
...
imply endorsement of Parallel. This provenance record is not legal advice
