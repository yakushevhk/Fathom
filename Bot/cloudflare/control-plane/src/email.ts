...
const SUBJECTS = {
  "sign-in": "Your Parallel sign-in code",
  "email-verification": "Verify your Parallel email",
  "forget-password": "Reset your Parallel password",
  "change-email": "Confirm your Parallel email change",
