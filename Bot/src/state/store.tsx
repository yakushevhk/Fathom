...
export function reducer(state: AppState, action: Action): AppState {
  ...
  switch (action.type) {
    ...
    case "toggleComputer": {
      ...
      const wideDesktop = typeof window !== "undefined" && window.innerWidth >= 1600;
      return {
        ...state,
        computerOpen: open,
        settingsOpen: open ? false : state.settingsOpen,
        inspectorOpen: open && !wideDesktop ? false : state.inspectorOpen,
        appSettingsOpen: open ? false : state.appSettingsOpen,
      };
    }
    case "toggleInspector": {
      ...
      return {
        ...
        inspectorOpen: open,
        settingsOpen: open ? false : state.settingsOpen,
        computerOpen: open && !wideDesktop ? false : state.computerOpen,
        appSettingsOpen: open ? false : state.appSettingsOpen,
      };
    }
