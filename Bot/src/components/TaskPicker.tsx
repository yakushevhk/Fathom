...
function ConversationTaskPicker({
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div className="absolute right-0 top-full z-40 mt-1 w-[calc(100vw-32px)] max-w-[320px] overflow-hidden rounded-xl border border-hairline/50 bg-card py-1 shadow-2xl shadow-black/50">
