# Parallel harness implementation plan
...
(pi, agent-orchestrator, deepseek-harness) and asking what Parallel lacked by
...
**The reframe that reorders everything.** Parallel is itself a harness. The
