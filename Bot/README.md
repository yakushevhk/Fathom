> ⚠️ **No affiliation with any cryptocurrency.** Parallel has no token. Any coin using the Parallel, Maus, or SupaMaus name is not created, endorsed, or affiliated with this project or its maintainer. I have received no tokens, payment, or allocation from anyone, and I will not be endorsing any token.
...
[![Release](https://img.shields.io/github/v/release/milind-soni/Parallel?label=release&color=1084fe&cacheSeconds=300)](https://github.com/milind-soni/Parallel/releases/latest)
![PRs](https://img.shields.io/badge/PRs-welcome-38d591)

<br>

<a href="https://github.com/milind-soni/Parallel/releases/latest/download/Parallel.dmg">
  <img src="https://img.shields.io/github/v/release/milind-soni/Parallel?style=for-the-badge&label=%E2%AC%87%EF%B8%8F%20%20Download%20for%20Mac%20%28Apple%20silicon%29&labelColor=070707&color=1084fe&cacheSeconds=300" alt="Download the latest Parallel for Mac with Apple silicon (.dmg)" height="40">
</a>
&nbsp;
<a href="https://github.com/milind-soni/Parallel/releases/latest/download/Parallel-intel.dmg">
  <img src="https://img.shields.io/github/v/release/milind-soni/Parallel?style=for-the-badge&label=%E2%AC%87%EF%B8%8F%20%20Download%20for%20Mac%20%28Intel%29&labelColor=070707&color=2a9d8f&cacheSeconds=300" alt="Download the latest Parallel for Intel Macs (.dmg)" height="40">
</a>
&nbsp;
<a href="https://github.com/milind-soni/Parallel/releases/latest/download/Parallel-setup.exe">
  <img src="https://img.shields.io/github/v/release/milind-soni/Parallel?style=for-the-badge&label=%E2%AC%87%EF%B8%8F%20%20Download%20for%20Windows&labelColor=070707&color=4cc2ff&cacheSeconds=300" alt="Download the latest Parallel for Windows (.exe)" height="40">
</a>
&nbsp;
<a href="https://github.com/milind-soni/Parallel/releases/latest/download/Parallel-amd64.deb">
  <img src="https://img.shields.io/github/v/release/milind-soni/Parallel?style=for-the-badge&label=%E2%AC%87%EF%B8%8F%20%20Download%20for%20Ubuntu&labelColor=070707&color=e95420&cacheSeconds=300" alt="Download the latest Parallel for Ubuntu (.deb)" height="40">
</a>

<sub>[latest release](https://github.com/milind-soni/Parallel/releases/latest) &nbsp;·&nbsp; macOS: Apple silicon & Intel · signed & notarized .dmg &nbsp;·&nbsp; Windows: x64 installer &nbsp;·&nbsp; Ubuntu 24.04 x64: .deb or AppImage beta &nbsp;·&nbsp; [all releases](https://github.com/milind-soni/Parallel/releases)</sub>

<br>

<a href="https://buy.polar.sh/polar_cl_bbnfWFUrWONIF4HnUpZf1p0if0eUYg3HeXct73b48Yg">
  <img src="https://img.shields.io/badge/%E2%9D%A4%EF%B8%8F%20%20Support%20Parallel-any%20amount%20%C2%B7%20or%20monthly-38d591?style=for-the-badge&labelColor=070707" alt="Support Parallel — one-time any amount or monthly, via Polar" height="40">
</a>

<br>
<br>

<img src="docs/screenshots/hero.png" alt="Parallel — a Telegram-style chat app where every chat is a real AI agent" width="900">
...
One assistant in one box is the wrong shape for agents. Parallel is an open-source take on **Grok Bot** —
...
Browse outcome-driven teams on [BotMRR](https://botmrr.io), then choose **Add to Parallel**. The app
...
The format stays portable: Parallel reads the structured YAML frontmatter for a reliable one-click
...
### Orchestrate Parallel over MCP

Parallel ships a stdio MCP server for external clients such as Claude Desktop and Cursor. It exposes a
...
**Released builds ([latest release](https://github.com/milind-soni/Parallel/releases/latest)):** the harness server is embedded, so no separate server setup is required.

| | Download | Install |
|---|---|---|
| **macOS** (Apple silicon) | [Parallel.dmg](https://github.com/milind-soni/Parallel/releases/latest/download/Parallel.dmg) | Drag it to Applications, open it. Signed & notarized. |
| **macOS** (Intel) | [Parallel-intel.dmg](https://github.com/milind-soni/Parallel/releases/latest/download/Parallel-intel.dmg) | Same app, built for Intel Macs. Signed & notarized. |
| **Windows** (x64) | [Parallel-setup.exe](https://github.com/milind-soni/Parallel/releases/latest/download/Parallel-setup.exe) | Run it — one-click, per-user, no admin rights. The installer isn't code-signed yet, so SmartScreen shows "unknown publisher": **More info → Run anyway**. |
| **Ubuntu 24.04** (x64) | [Parallel-amd64.deb](https://github.com/milind-soni/Parallel/releases/latest/download/Parallel-amd64.deb) · [Parallel.AppImage](https://github.com/milind-soni/Parallel/releases/latest/download/Parallel.AppImage) | Install the `.deb` with APT (recommended), or make the AppImage executable and run it. Beta; GNOME is the supported desktop. |
...
issues [#29](https://github.com/milind-soni/Parallel/issues/29),
[#345](https://github.com/milind-soni/Parallel/issues/345), and
[#113](https://github.com/milind-soni/Parallel/issues/113).
...
|---|---|---|
| Composio project key (`ak_…`) | Connect Gmail, GitHub, Slack, Notion, and other apps to your bots | [Parallel Composio setup](docs/composio.md) |
...
Parallel starts a webhook-only receiver on `127.0.0.1:8800` by default (or one port above `OMB_PORT`).
...
Parallel must remain running to accept a delivery. For public internet delivery, proxy only this
...
Parallel is free and open source. If it does real work for you, you can
...
[Apache License 2.0](LICENSE) © 2026 Milind Soni and Parallel contributors,
...
Parallel is an independent, open-source project inspired by Grok Bot. It is
