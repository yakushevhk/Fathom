  ...
  JSON.stringify(
    {
      name: "openmausbot",
      version: app.version,
      description: "Run the Parallel server anywhere and pair your devices to it",
      license: "Apache-2.0",
      type: "module",
      bin: { openmausbot: "cli.js" },
      files: ["cli.js", "dist-server", "dist", "skills", "enterprise", "LICENSE", "README.md"],
      engines: { node: ">=24" },
      repository: { type: "git", url: "https://github.com/milind-soni/Parallel.git" },
      homepage: "https://github.com/milind-soni/Parallel#readme",
...
Managed access uses a separate Parallel account and asks permission for
...
Parallel iOS app can also scan or accept the full link. This CLI link
...
\`login\` command signs in to an Parallel account, not an AI provider;
it does not start the tunnel itself.

[Setup guide](https://github.com/milind-soni/Parallel/blob/main/docs/cli-onboarding.md)
· [Hosting guide](https://github.com/milind-soni/Parallel/blob/main/docs/self-hosting.md)
`,
);
