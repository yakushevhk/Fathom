...
.gpui-user-meta { font-size: 11px; font-weight: 500; color: #a1a1aa; }
  ...
  <div class="gpui-body">
    ...
    <div class="gpui-sidebar">
      ...
      <div class="gpui-user-pill">
        <div class="gpui-user-icon">AK</div>
        <div class="gpui-user-meta">Avery Kim · Tokyo Node</div>
      </div>
    </div>
...
# ==============================================================================
# 10 DETAILED GPUI METAL SCENARIOS WITH EXTENSIVE TOOL CALLING
# ==============================================================================
...
print("\nAll 10 GPUI Metal HTML screens generated. Rendering HD Retina PNGs in parallel...")
...
with concurrent.futures.ThreadPoolExecutor(max_workers=6) as ex:
    results = list(ex.map(render_gpui_png, mockup_names))
...
print("\nALL 10 GPUI METAL RETINA PNG SCREENSHOTS GENERATED SUCCESSFULLY!")
